...
# Target = [9, 9]
Target = [0.11189747519149787, 36.718618968711546]
all_points_x=np.append(all_points_x, Target[1])
all_points_y=np.append(all_points_y, Target[0])
Home = [0.07690274234471656, 36.87651256671905]
all_points_x=np.append(all_points_x, Home[1])
all_points_y=np.append(all_points_y, Home[0])
obstacles_small = [[0.07666939044731437, 36.86985398290678, 50], [0.08262925305514245, 36.86973462460619, 110], [0.08617405629275764, 36.84758104378239, 130], [0.08300195702339881, 36.8422300214085, 45], [0.09302424368173884, 36.81457907347337, 11], [0.10823022645912367, 36.74844581615037, 30], [0.10633527850737491, 36.74222565848995, 100]]
...
obstacles_large = obstacles_large = [[(0.10459047512914653, 36.75547052155639), (0.10354977976834119, 36.755073554622626), (0.10216576215680663, 36.75521302949116), (0.1009158547309918, 36.754236705410136), (0.09971959134486041, 36.753700263607236), (0.09886665014836615, 36.75377000104153), (0.09912414182446054, 36.75462830792535), (0.10003609151522831, 36.75452638398304), (0.10111970228710009, 36.75558317433381), (0.10277730483253583, 36.756462938890834), (0.10387164430987955, 36.75612498055533)]]
...
def plot_image():
  ...
  ax.imshow(background_image, extent=[36.7, 36.9, 0.05, 0.15])
  plt.xticks([])
  plt.yticks([])
